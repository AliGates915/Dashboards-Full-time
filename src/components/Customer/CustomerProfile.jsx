  ...
  return (
    <div>
      <div className="w-full h-screen bg-white mx-14 font-[sans-serif] pt-4">
        ...
        <h1 className='text-blue text-xl font-bold'>Personal Information</h1>
        
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="grid sm:grid-cols-3 gap-8">
            <div>
              <label className="text-gray-800 text-md mb-2 block">Company</label>
              <input
                name="name"
                type="text"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">Person</label>
              <input
                name="address"
                type="text"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">Designation</label>
              <input
                name="company"
                type="text"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">Address</label>
              <input
                name="companyAddress"
                type="text"
                required
          ...
          <h1 className='text-blue text-xl font-bold my-6'>Order Information</h1>

          <form onSubmit={(e) => e.preventDefault()}>
            <div className="grid sm:grid-cols-3 gap-8">
            <div>
              <label className="text-gray-800 text-md mb-2 block">City *</label>
              <input
                name="number"
                type="text"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">Logo Picture *</label>
              <input type="file" name="Choose file" id="upload" />
            </div>
            <div>
              <label className="text-gray-800 text-md mb-2 block">Mobile Number *</label>
              <input
                name="number"
                type="number"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">Username/Email address *</label>
              <input
                name="companyAddress"
                type="text"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">NTN *</label>
              <input
                name="number"
                type="number"
                required
            ...
            <div>
              <label className="text-gray-800 text-md mb-2 block">STRN *</label>
              <input
                name="email"
                required
                type="text"
            ...
            <div>
              ...
              <div className="relative flex mr-20">
                ...
                <svg
                  ...
                  fill="#bbb"
                  stroke="#bbb"
                  className="w-[18px] h-[18px] absolute right-28 cursor-pointer"
          ...
          <div className=' flex justify-start'>
            ...
            className="bg-blue text-white text-md font-bold w-40 py-2 mt-6 rounded-xl hover:bg-[#005a59]"
          >
            Submit
          </button>
          </div>
