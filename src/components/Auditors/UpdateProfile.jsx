    ...
    <div>
      <div className="w-90 h-screen bg-white ml-36 font-[sans-serif] pt-4">
        <div className="text-center mb-8">
          <h4 className="text-blue text-2xl font-bold">Auditor Detail</h4>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='ml-20 my-4'>
              <label className="text-gray-800 text-lg mb-2 block">Branch *</label>
              <input
              ...
              />  
              {errors.city && <span className="text-red-500">Branch is required</span>} 
            </div>
          ...
          <div >
            ...
            <div >
              <label className="text-gray-800 text-lg mb-2 block">Country </label>
              <input
          ...
          <div className="mr-48 ml-20 grid sm:grid-cols-2 gap-6">
            ...
            <div>
              <label className="text-gray-800 text-lg mb-2 block">Email address *</label>
              <input
          ...
          <div className='mt-4 mr-48 ml-20 grid sm:grid-cols-1 gap-6'>
          <div>
              <label className="text-gray-800 text-lg mb-2 block">Education/Degrees</label>
              <input
                type="text"
                className="w-[24rem] bg-transparent text-gray-800 text-sm border-b border-gray-300 focus:border-blue px-2 py-2 outline-none"
                placeholder="Enter Education or Degrees"
              />
          ...
          <div className="flex justify-center my-6">
            <button
              type="submit"
              className="text-white w-80 bg-blue hover:bg-[#005a59] mb-4 py-2 font-semibold rounded-full"
            >
              SUMBIT
            </button>
          </div>
